...
func TestCustomComparable(t *testing.T) {
    ...
    list := New[*testCustomComparable, string](comparable)
    list.Set(k1, "k1")
    list.Set(k2, "k2")
    list.Set(k3, "k3")
    ...
    list = New[*testCustomComparable, string](Reverse(comparable))
    list.Set(k1, "k1")
    list.Set(k2, "k2")
    list.Set(k3, "k3")
    ...
    list = New[*testCustomComparable, string](LessThanFunc(comparable))
    list.Set(k1, "k1")
    list.Set(k2, "k2")
    list.Set(k3, "k3")
...
func ExampleGreaterThanFunc() {
    ...
    list := New[T, string](GreaterThanFunc(func(k1, k2 interface{}) int {
...
func assertSanity(a *assert.A, list *SkipList[KTest, VTest]) {
    l := list.Len()
    ...
    allElems := make([]*Element[KTest, VTest], 0, l)
